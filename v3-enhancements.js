...
window.BENNI_VARIANTS={
 simmi:[
  ...
  {src:'assets/simmi.jpg',label:'Gold',filter:'sepia(1) saturate(4) hue-rotate(350deg) brightness(1.08)'},
  {src:'assets/simmi.jpg',label:'Black',filter:'grayscale(1) brightness(.42)'},
  {src:'assets/simmi.jpg',label:'Grey',filter:'grayscale(.9) brightness(.78) contrast(.9)'},
  {src:'assets/simmi.jpg',label:'Brown',filter:'sepia(.72) saturate(1.45) hue-rotate(335deg) brightness(.82)'}
 ],
 polene:[
  {src:'assets/polene.jpg',label:'Burgundy',filter:'none'},
  {src:'assets/polene.jpg',label:'Tan',filter:'sepia(.6) saturate(1.55) hue-rotate(345deg) brightness(1.02)'},
  {src:'assets/polene.jpg',label:'Black',filter:'grayscale(1) brightness(.38)'}
 ],
 shoulder:[
  {src:'assets/shoulder.jpg',label:'Dark Brown',filter:'none'},
  {src:'assets/shoulder.jpg',label:'Burgundy',filter:'sepia(.35) saturate(2.05) hue-rotate(300deg) brightness(.88)'},
  {src:'assets/shoulder.jpg',label:'Black',filter:'grayscale(1) brightness(.38)'}
 ],
 tote:[
  {src:'assets/tote.jpg',label:'Teal Leopard',filter:'none'},
  {src:'assets/tote.jpg',label:'Pink Leopard',filter:'sepia(.18) saturate(2.2) hue-rotate(300deg) brightness(1.08)'}
 ],
 chick:[
  {src:'assets/chick.jpg',label:'Blue Multi',filter:'none'},
  {src:'assets/chick.jpg',label:'Gold Multi',filter:'sepia(.58) saturate(2.1) hue-rotate(350deg) brightness(1.02)'},
  {src:'assets/chick.jpg',label:'Neutral Multi',filter:'sepia(.2) saturate(.72) hue-rotate(335deg) brightness(1.03)'}
 ],
 zara:[
  {src:'assets/zara.jpg',label:'Pink',filter:'none'},
  {src:'assets/zara.jpg',label:'Brown',filter:'sepia(.62) saturate(1.55) hue-rotate(350deg) brightness(.92)'}
 ]
};
